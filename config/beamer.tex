...
\usepackage{textpos}
  \addtobeamertemplate{frametitle}{}{%
    \begin{textblock*}{100mm}(.79\textwidth,-0.7cm)
      \includegraphics[height=0.5cm]{figures/logo/SUSTech-en.pdf}
    \end{textblock*}
  }
\mode<presentation>{
...
\usetheme{AnnArbor} % or other themes, see http://www.hartwork.org/beamer-theme-matrix/
...
\AtBeginDocument{
  \begin{frame}
    \titlepage
    \vfill\hfill
    \inserttitlegraphic{\includegraphics[height=0.5cm]{figures/logo/SUSTech-en.pdf}}
  \end{frame}
