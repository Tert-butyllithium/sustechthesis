...
\begin{table}
    ...
    \scalebox{1}{
        \begin{tabular}[]{@{}lll@{}}
            \toprule
            \textbf{Program} & \textbf{\#Syscalls} & \textbf{Data Recovery} \\
            \midrule
            shared\_counter  & 172                     & 100\%                  \\
            log\_proc\_sweep & 264                     & 100\%                  \\
            bank\_account    & 387                     & 100\%                  \\
            circular\_list   & 2108                    & 100\%                  \\
            mysql-169        & 3867                    & 100\%                  \\
            pbzip2           & 8053                    & 99.7\%                  \\
            \bottomrule
        \end{tabular}}
...
In this section, I shows \TheName is a universal tool for almost all Linux devices. \TheName is basically a kernel module that does not need any dependency. All functions of \TheName are implemented in Linux kenrel, whcih indicates that \TheName is architecture-independent.

I also have verified on different platforms beyond ARM juno board. The specification of the platform parameters are as follows.
\begin{itemize}
...
Although I have not implemented all the features on devices of other architectures, the core part of \TheName, i.e., system call capturing, works fine. Besides, there are some recent work to make some extensions based on \TheName on riscv \cite{gdjs2_gdjs2mysisdig_2021}. This confirms the universality of \TheName.